...
public class ProductDetail extends HttpServlet{
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		out.println("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\">");
		 ...
		 out.println("				");
		 out.println("				<td class=tablebody1 valign=\"middle\" width=\"75%\">");
		 out.println("				"+category.getName()+" "+category.getDescription()+"<br>");
		 out.println("				</td>");
		 out.println("			</tr>");
		 out.println("			<tr>");
		 ...
		 out.println("				<td class=tablebody1 valign=\"middle\" width=\"75%\">");
		 out.println("				&nbsp");
		 out.println("				<img src=\"images/product/zcover2.gif\">");
		 out.println("				</td>");
		 out.println("			</tr>");
		 out.println("			");
		 out.println("			<tr>");
		 out.println("			<td colspan=\"2\" class=tablebody2 valign=\"top\" align=\"center\" width=\"100%\" height=\"32\"> ");
		 out.println("				<a href=\"/TarenaStore/shoppingC\"><img border=\"0\" src=\"images/buycar.gif\" ></a> ");
		 out.println("    		</td>");
		 out.println("    		</tr>");
		 out.println("			");
		 out.println("		</table>");
