...
out.println("				<form>");
out.println("					<input type=\"button\" value=\"提交订单\" size=\"1\" onclick=\"javascript:window.location='/TarenaStore/orderC';\">");
out.println("					<input type=\"button\" value=\"继续购物\" size=\"2\" onclick=\"javascript:window.location='/TarenaStore/productL';\">");
out.println("					<input type=\"button\" value=\"清空购物车\" size=\"2\" onclick=\"javascript:window.location='/TarenaStore/productL';\">");
out.println("				</form>");
out.println("				</td>");
out.println("			</tr>");
out.println("		</table>");
